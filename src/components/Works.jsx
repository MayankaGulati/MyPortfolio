          ...
          {/* <div className="absolute inset-0 flex justify-end m-3 card-img_hover ">
            ...
            >
              <img
                src={github}
                alt="github"
                className="w-1/2h h-1/2 object-contain"
              />
            </div>
          </div> */}
        </div>
        <div className="mt-5">
          <h3 className=" text-white font-white font-[24px]">{name}</h3>
    ...
    <>
      ...
      <div className=" w-full flex">
        ...
        >
          ...
          world examples of my work. It reflects my ability to solve complex
